 ...
 */
    [_FUNCTION] = LAYOUT(
      ...
      XXXXXXX, _______, _______, _______, _______, XXXXXXX,                                     XXXXXXX, KC_F1,   KC_F2,   KC_F3,   A(KC_F4), QK_LLCK,
 ...
 */
    [_SYMBOLS] = LAYOUT(
        ...
        ES_MINS, ES_ASTR, ES_PLUS, ES_LPRN, ES_RPRN, ES_EQL,                                      ES_SCLN, ES_LABK, ES_RABK, ES_SLSH, ES_BSLS,      QK_LLCK,
 ...
 */
    [_CONFIG]= LAYOUT(
      ...
      XXXXXXX, XXXXXXX, RGB_VAD, RGB_SAD, RGB_HUD, RGB_TOG,                                     XXXXXXX, KC_MPLY, KC_MUTE, XXXXXXX, XXXXXXX, QK_LLCK,
